...
app = Flask(__name__)
app.secret_key = 'suresh@' # IMPORTANT: Change this to a strong, random key in production!
...
SNS_TOPIC_ARN = 'arn:aws:sns:us-east-1:715841346262:travelgoproject:8d131f16-723b-4da2-9bba-af988e07b467'  # Replace with actual SNS topic ARN
